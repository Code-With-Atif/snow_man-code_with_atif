#Code it written by Atif Ahmad
#if u need any type of help contact me on my insta 
#instagram id : _atifahmad_
#thnx for using my code ;)
...
class Main():
    ...
    def __init__(self):
        ...
        while game_state != 2:
            ...
            screen = self.setup_pygame("SnowMan - Code With Atif", WIDTH, HEIGHT)
